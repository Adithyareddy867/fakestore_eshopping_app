...
export function StyleBinding(){
    ...
    function handlePasswordChange(e){
        if(e.target.value.length===0){
            setStyleObject({border:'2px solid red' ,boxShadow:'2px 2px 2px green'});
    ...
    return(
        <div className="container-fluid">
            ...
            <dl>
                ...
                <dt>Password</dt>
                <dt><input type="password"className="remove-outline" onChange={handlePasswordChange} style={styleObject} /></dt>
            </dl>
        </div>
    )
}